...
function PlantDetails() {
  ...
  // New compact mobile pagination component
  ...
  return (
    <div className="plant-details-section">
      <NavigationButtons className="top desktop-only" />
      
      <div 
        className="plant-details-container" 
      ...
      >
        <div className="plant-details-gallery">
          ...
          {/* Add mobile pagination at top of details on mobile */}
      ...
      <NavigationButtons className="bottom desktop-only" />
    </div>
  );
}
